...
export function getBreadingApplication(id) {
  return request(`/adopt/breading/${id}`, {
    method: 'GET',
  })
}
...
export function uploadDonationFile(uuid, file) {
  const formData = new FormData()
  formData.append('file', file)
  return request(`/items/donations/upload/${uuid}`, {
    method: 'POST',
    body: formData,
  })
}
...
export function deleteDonationFile(uuid, filename) {
  return request(`/items/donations/upload/${uuid}/${encodeURIComponent(filename)}`, {
    method: 'DELETE',
  })
}

export function getDonation(id) {
  return request(`/items/donations/${id}`, {
    method: 'GET',
  })
}
...
export function updateDonationStatus(id, payload) {
  return request(`/items/donations/${id}/status`, {
    method: 'PATCH',
    body: payload,
  })
}
...
export function updateCategory(id, payload) {
  return request(`/items/categories/${id}`, {
    method: 'PUT',
    body: payload,
  })
}
...
export function getStock(id) {
  return request(`/items/stocks/${id}`, {
    method: 'GET',
  })
}
...
export function getSubscribe(id) {
  return request(`/items/subscribe/${id}`, {
    method: 'GET',
  })
}
