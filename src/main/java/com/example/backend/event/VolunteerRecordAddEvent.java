 ...
 */
public record VolunteerRecordAddEvent(VolunteerShift shift, VolunteerServiceRecord data, User user) implements INotifyEvent<VolunteerServiceRecord> {
    @Override
    ...
    public String buildNotifyContent(LangHelper langHelper, Object... args) {
        return langHelper.get("notification.volunteer_record_add.content", shift.getTitle());
    }
}
