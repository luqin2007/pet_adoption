 ...
 */
public record VolunteerShiftUpdateEvent(VolunteerShift data, User user) implements INotifyEvent<VolunteerShift> {
    @Override
    ...
    public String buildNotifyContent(LangHelper langHelper, Object... args) {
        return langHelper.get("notification.volunteer_shift_update.content", data.getTitle());
    }
    ...
    public String buildMailContent(LangHelper langHelper, Object... args) {
        return langHelper.get("mail.volunteer_shift_update.content", data.getTitle());
    }
}
